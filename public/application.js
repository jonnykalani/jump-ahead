...
var getWebpages = function getWebpages() {
  token = '';
  if (store.user) {
...
var getWebpage = function getWebpage(data) {
  token = '';
  if (store.user) {
    token = store.user.token;
  }
...
var getOwnedWebpages = function getOwnedWebpages(data) {
  token = '';
  if (store.user) {
    token = store.user.token;
  }
...
var deleteWebpage = function deleteWebpage(data) {
  // if (data.webpage) {
  //   id = data.webpage.id
  // } else {
  //   id = data
...
var createWebpage = function createWebpage(data) {
  return $.ajax({
    url: config.apiUrl + '/webpages/',
    method: 'POST',
    headers: {
...
var updateWebpage = function updateWebpage(data) {
  return $.ajax({
...
module.exports = {
  ...
  getOwnedWebpages: getOwnedWebpages,
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://cryptic-shelf-20832.herokuapp.com',
...
var addNestedValue = __webpack_require__(24);
...
var blogInfoTemplate = __webpack_require__(44);
var blogInfoTemplateWithButtons = __webpack_require__(45);
var store = __webpack_require__(2);
var compare = __webpack_require__(11);
var blogInfoData = void 0;

var blogPostCreateSuccess = function blogPostCreateSuccess(data) {
...
var blogPostCreateFailure = function blogPostCreateFailure(error) {
  $('#create-blogPost-modal').modal('hide');
...
var blogPostShowSuccess = function blogPostShowSuccess(data) {
...
var blogPostShowFailure = function blogPostShowFailure(error) {
...
var blogPostIndexSuccess = function blogPostIndexSuccess(data) {
...
var blogPostIndexFailure = function blogPostIndexFailure(error) {
...
var blogPostUpdateSuccess = function blogPostUpdateSuccess(data) {
...
var blogPostUpdateFailure = function blogPostUpdateFailure() {
  $('#update-blogPost-modal').modal('hide');
  $('#message').text('Error on creating a blog post!');
  $('#message').removeClass('alert-success').addClass('alert-danger').show();
  $('form').find('input:not([type="submit"])').val('');
...
var blogPostDeleteSuccess = function blogPostDeleteSuccess(data) {
...
var blogPostDeleteFailure = function blogPostDeleteFailure(error) {
  $('#confirmDeleteBlogPostModal').modal('hide');
...
var showBlogPosts = function showBlogPosts(data) {
  console.log('data in showBlogPosts is ', data);
...
module.exports = {
  blogPostCreateSuccess: blogPostCreateSuccess,
  blogPostCreateFailure: blogPostCreateFailure,
  blogPostIndexSuccess: blogPostIndexSuccess,
  blogPostIndexFailure: blogPostIndexFailure,
  blogPostShowSuccess: blogPostShowSuccess,
  blogPostShowFailure: blogPostShowFailure,
  blogPostUpdateSuccess: blogPostUpdateSuccess,
  blogPostUpdateFailure: blogPostUpdateFailure,
  blogPostDeleteSuccess: blogPostDeleteSuccess,
  blogPostDeleteFailure: blogPostDeleteFailure,
...
var blogPostIndex = function blogPostIndex() {
  token = '';
  if (store.user) {
    token = store.user.token;
  }
...
var blogPostShow = function blogPostShow(data) {
  id = data;
  if (data.blogPost) {
    id = data.blogPost.id;
  }
...
var getOwnedBlogposts = function getOwnedBlogposts(data) {
  token = '';
  if (store.user) {
    token = store.user.token;
  }
...
var blogPostDelete = function blogPostDelete(data) {
  id = data;
  if (data.blogPost) {
    id = data.blogPost.id;
  }
...
var blogPostCreate = function blogPostCreate(data) {
  return $.ajax({
    url: config.apiUrl + '/blogPosts/',
    method: 'POST',
    headers: {
...
var blogPostUpdate = function blogPostUpdate(data) {
  return $.ajax({
...
function compare(a, b) {
  var postA = a.createdAt;
  var postB = b.createdAt;
...
var imageIndex = function imageIndex() {
  token = '';
  if (store.user) {
    token = store.user.token;
  }
...
var getOwnedImages = function getOwnedImages(data) {
...
var imageDelete = function imageDelete(data) {
  id = data;
  if (data.image) {
    id = data.image.id;
  }
...
var imageInfoTemplate = __webpack_require__(50);
var imageInfoTemplateWithButtons = __webpack_require__(51);
var store = __webpack_require__(2);
var compare = __webpack_require__(11);
var imageInfoData = void 0;

var imageCreateSuccess = function imageCreateSuccess(data) {
...
var imageDeleteSuccess = function imageDeleteSuccess(data) {
...
module.exports = {
  imageCreateSuccess: imageCreateSuccess,
...
var createWebpageSuccess = function createWebpageSuccess(data) {
...
var createWebpageFailure = function createWebpageFailure(error) {
  store.error = error;
  $('#create-webpage-modal').modal('hide');
...
var getWebpagesSuccess = function getWebpagesSuccess(data) {
  $('#message').text('Retrieved webpages successfully!');
  $('#message').removeClass('alert-danger').addClass('alert-success').show();
  $('form').find('input:not([type="submit"])').val('');
};

var getWebpagesFailure = function getWebpagesFailure(error) {
  store.error = error;
...
var getWebpageSuccess = function getWebpageSuccess(data) {
  $('#message').text('Retrieved webpage successfully!');
  $('#message').removeClass('alert-danger').addClass('alert-success').show();
  $('form').find('input:not([type="submit"])').val('');
};

var getWebpageFailure = function getWebpageFailure() {
  // store.error = error
...
var updateWebpageSuccess = function updateWebpageSuccess(data) {
...
var updateWebpageFailure = function updateWebpageFailure() {
  // console.log(error)
  $('#update-webpage-modal').modal('hide');
...
var deleteWebpageSuccess = function deleteWebpageSuccess(data) {
...
var deleteWebpageFailure = function deleteWebpageFailure() {
  // console.log(error)
  $('#confirmDeleteWebpageModal').modal('hide');
  $('#message').text('Error on deleting webpage!');
  $('#message').removeClass('alert-success').addClass('alert-danger').show();
...
module.exports = {
  createWebpageSuccess: createWebpageSuccess,
  createWebpageFailure: createWebpageFailure,
  getWebpagesSuccess: getWebpagesSuccess,
  getWebpagesFailure: getWebpagesFailure,
  getWebpageSuccess: getWebpageSuccess,
  getWebpageFailure: getWebpageFailure,
  updateWebpageSuccess: updateWebpageSuccess,
  updateWebpageFailure: updateWebpageFailure,
  deleteWebpageSuccess: deleteWebpageSuccess,
  deleteWebpageFailure: deleteWebpageFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var usersDropdownTemplate = __webpack_require__(26);
var compare = __webpack_require__(43);

var getUserDropdown = function getUserDropdown() {
  api.userIndex().then(function (response) {
    response.users.sort(compare);
    var usersDropdownHtml = usersDropdownTemplate({ users: response.users });
...
var blogUi = __webpack_require__(9);
var blogApi = __webpack_require__(10);
var webpageApi = __webpack_require__(5);
var orgInfoTemplate = __webpack_require__(46);
var showOnePageTemplate = __webpack_require__(47);
var showOnePageTemplateWithButtons = __webpack_require__(48);
var webpageLinksTemplate = __webpack_require__(49);
var compare = __webpack_require__(11);
var store = __webpack_require__(2);
var userApi = __webpack_require__(6);
var imageApi = __webpack_require__(12);
var imageUi = __webpack_require__(13);
var webpage = void 0;

var viewImageInfo = function viewImageInfo(data) {
  console.log('viewImageInFo is running');
  var orgInfoData = orgInfoTemplate({ users: data });
  $('#content').html(orgInfoData);
  store.viewed_user.organization = data.user.organization;
  return data;
};

var viewOrgInfo = function viewOrgInfo(data) {
  console.log('viewOrgInfo is running');
  // viewImageInfo(data)
  var orgInfoData = orgInfoTemplate({ users: data });
  $('#content').html(orgInfoData);
  store.viewed_user.organization = data.user.organization;
  $('.showblogbutton').on('click', function () {
    return onShowBlogPosts(data);
  });
...
var showWebpageLinks = function showWebpageLinks(data) {
  data.webpages.sort(compare);
  var webpageLinks = webpageLinksTemplate({ webpages: data.webpages });
  $('#page-links').html(webpageLinks);
  $('.individual-page-link').on('click');
  $('.individual-page-link').on('click', showWebpageByLink);
};

var showWebpageByLink = function showWebpageByLink(event) {
  var id = $(event.target).data('id');
  webpageApi.getWebpage(id).then(function (response) {
    return response;
  }).then(function (data) {
    if (store.user) {
      if (store.user.id === store.viewed_user.user_id) {
    ...
    return $('#back-link').on('click', goBackToMain);
  });
};

var goBackToMain = function goBackToMain() {
  userApi.getUser(store.viewed_user.user_id).then(viewImageInfo).then(viewOrgInfo).then(function (response) {
    return response;
  }).then(function () {
    return webpageApi.getOwnedWebpages(store.viewed_user.user_id);
  }).then(showWebpageLinks).catch(console.error);
};

var onShowBlogPosts = function onShowBlogPosts(data) {
  console.log('onShowBlogPosts is running');
  blogApi.getOwnedBlogposts(data.user.id)
  // .then((response) => console.log('response is', response))
  .then(blogUi.showBlogPosts).then(function () {
    return $('#back-link').on('click', goBackToMain);
  }).catch(console.error);
};

var onUploadImages = function onUploadImages(data) {
  console.log('onUploadImages in UI is running');
  imageApi.getOwnedImages(data.user.id).then(imageUi.showImages).then(function () {
    return $('#back-link').on('click', goBackToMain);
  }).catch(console.error);
};

module.exports = {
  viewOrgInfo: viewOrgInfo,
  showWebpageLinks: showWebpageLinks,
  showWebpageByLink: showWebpageByLink,
...
var onCreateWebpage = function onCreateWebpage(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createWebpage(data).then(ui.createWebpageSuccess).catch(ui.createcreateWebpageFailure);
};

var onGetWebpages = function onGetWebpages(event) {
  event.preventDefault();
  api.getWebpages().then(ui.getWebpagesSuccess).catch(ui.getWebpagesFailure);
};

var onGetWebpage = function onGetWebpage(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var webpage = data.webpage;
  // console.log(event)
  api.getWebpage(webpage.id).then(ui.getWebpageSuccess).catch(ui.getWebpageFailure);
};

var onUpdateWebpage = function onUpdateWebpage(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateWebpage(data).then(function () {
    return ui.updateWebpageSuccess(data);
  }).then(function (data) {
    return api.getWebpage(data.webpage.id);
...
var onDeleteWebpage = function onDeleteWebpage(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var webpage = data.webpage;
  api.deleteWebpage(webpage.id).then(ui.deleteWebpageSuccess).catch(ui.deleteWebpageFailure);
};
...
module.exports = {
  ...
  onUpdateWebpage: onUpdateWebpage
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onBlogPostCreate = function onBlogPostCreate(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.blogPostCreate(data).then(ui.blogPostCreateSuccess).catch(ui.blogPostCreateFailure);
};
var onBlogPostShow = function onBlogPostShow(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.blogPostShow(data).then(ui.blogPostShowSuccess).catch(ui.blogPostShowFailure);
};
var onBlogPostIndex = function onBlogPostIndex(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.blogPostIndex(data).then(ui.blogPostIndexSuccess).catch(ui.blogPostIndexFailure);
};
var onBlogPostUpdate = function onBlogPostUpdate(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.blogPostUpdate(data).then(function () {
    return ui.blogPostUpdateSuccess();
  })
  // .then(() => api.blogPostShow())
  // .then(ui.blogPostShowSuccess)
  .catch(ui.blogPostUpdateFailure);
...
var onBlogPostDelete = function onBlogPostDelete(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.blogPostDelete(data).then(ui.blogPostDeleteSuccess).catch(ui.blogPostDeleteFailure);
};
...
var userEvents = __webpack_require__(23);
var webpageEvents = __webpack_require__(18);
var blogPostEvents = __webpack_require__(19);
var userDropdown = __webpack_require__(15);
var deleteEvents = __webpack_require__(52);
var updateEvents = __webpack_require__(53);
var imageEvents = __webpack_require__(56);
...
$(function () {
  ...
  $('.modal').on('hidden.bs.modal', function () {
    return $('form').find('input:not([type="submit"])').val('');
  });
  $('.modal').on('hidden.bs.modal', function () {
    return $('textarea').val('');
  });
...
var wpApi = __webpack_require__(5);
var store = __webpack_require__(2);
var viewMain = __webpack_require__(17);
...
var onViewOrgInfo = function onViewOrgInfo(event) {
  event.preventDefault();
  ...
  .then(viewMain.viewOrgInfo).then(function () {
    return wpApi.getOwnedWebpages(data.users.user_id);
  }).then(viewMain.showWebpageLinks).catch(console.error);
};
...
var signUpSuccess = function signUpSuccess(data) {
  ...
  // $('#message').delay(3000).slideToggle()
  var myNewData = { // made a new const called myNewData
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <option value=\""
    ...
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.organization : stack1), depth0))
    + "</option>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<select class=\"form-control\" id=\"user-dropdown\" name=\"users[user_id]\" required>\n  <option value=\"\" selected disabled hidden>Choose a company to view</option>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.users : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</select>\n";
...
function compare(a, b) {
  var organizationA = a.organization.toLowerCase();
  var organizationB = b.organization.toLowerCase();
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div data-id=\""
    ...
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1._owner : stack1)) != null ? stack1.organization : stack1), depth0))
    + "</h2>\n    <h2 class=\"resource-header\">"
  ...
  return "\n  <h2 class=\"resource-body\">"
    ...
    + " has not posted any blog entries yet</h2>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.blogPosts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.program(3, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n<span class=\"page-links\" id=\"back-link\">Return to Main</span>\n";
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div data-id=\""
    ...
    + "</li>\n      <li class=\"resource-header\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</li>\n        <br />\n        <li class=\"resource-body\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
    + "</li>\n        <li class=\"resource-body\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.createdAt : stack1), depth0))
    + "</li>\n        <button class=\"blogPost-update blogpost-btn btn btn-sm btn-info\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">Update</button>\n        <!-- <br /> -->\n        <button class=\"blogPost-delete blogpost-btn btn btn-sm btn-danger\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">Delete</button>\n      </ul>\n    </div>\n  </div>\n";
},"3":function(container,depth0,helpers,partials,data) {
    var helper;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <h1 class=\"resource-header\" class=\"org-name\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.organization : stack1), depth0))
    + "</h1>\n  <h3 class=\"resource-body\" class=\"org-description\">Who are we? "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.company_description : stack1), depth0))
    + "</h3>\n  <h3 class=\"resource-body\" class=\"org-phone\">Phone: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.phone_number : stack1), depth0))
    + "</h3>\n  <h3 class=\"resource-body\" class=\"org-email\">Email: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email : stack1), depth0))
    + "</h3>\n  <h3 class=\"resource-body\" class=\"org-address\">Address: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.address : stack1), depth0))
    + "</h3>\n  <button class=\"btn btn-info showblogbutton\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">See blog posts</button>\n  <button class=\"btn btn-info showimagebutton\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">See images</button>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
  ...
  return "\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.users : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "<div class=\"resource-body\" class=\"page-links\" id=\"page-links\"></div>\n";
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<h1 class=\"resource-header\">"
    + alias1(((helper = (helper = helpers.organization || (depth0 != null ? depth0.organization : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"organization","hash":{},"data":data}) : helper)))
    + "</h1>\n<h2 class=\"resource-header\">"
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.webpage : depth0)) != null ? stack1.title : stack1), depth0))
    + "</h2>\n<div class=\"resource-body\">"
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.webpage : depth0)) != null ? stack1.body : stack1), depth0))
    + "</div>\n\n<span class=\"page-links\" id=\"back-link\">Return to Main</span>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<h1 class=\"resource-header\">"
    ...
    + "</h2>\n<div class=\"resource-body\">"
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.webpage : depth0)) != null ? stack1.body : stack1), depth0))
    + "</div>\n<button class=\"webpage-update btn btn-sm btn-info webpage-btn\" data-id="
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.webpage : depth0)) != null ? stack1.id : stack1), depth0))
    + ">Update</button>\n<button class=\"webpage-delete btn btn-sm btn-danger webpage-btn\" data-id="
    + alias1(alias2(((stack1 = (depth0 != null ? depth0.webpage : depth0)) != null ? stack1.id : stack1), depth0))
    + ">Delete</button>\n<br>\n<span class=\"page-links\" id=\"back-link\">Return to Main</span>\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<ul>\n  <span class=\"page-links individual-page-link\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</span>\n</ul>\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.webpages : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <h2 class=\"resource-body\">"
    + container.escapeExpression(((helper = (helper = helpers.organization || (depth0 != null ? depth0.organization : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"organization","hash":{},"data":data}) : helper)))
    + " has not posted any image entries yet</h2>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.images : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.program(3, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n<span class=\"page-links\" id=\"back-link\">Return to Main</span>\n";
},"useData":true,"useBlockParams":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div data-id=\""
    ...
    + "</li>\n      <li class=\"resource-header\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</li>\n        <br />\n        <li class=\"resource-body\"><img src="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "></li>\n        <li class=\"resource-body\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.createdAt : stack1), depth0))
    + "</li>\n        <button class=\"image-update blogpost-btn btn btn-sm btn-info\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">Update</button>\n        <!-- <br /> -->\n        <button class=\"image-delete image-btn btn btn-sm btn-danger\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">Delete</button>\n      </ul>\n    </div>\n  </div>\n";
},"3":function(container,depth0,helpers,partials,data) {
    var helper;
...
var webpagesApi = __webpack_require__(5);
// const webpagesEvents = require('./webpages/events.js')
var webpagesUI = __webpack_require__(14);
var blogPostsApi = __webpack_require__(10);
var blogPostsUI = __webpack_require__(9);
var viewMain = __webpack_require__(17);
var imagesApi = __webpack_require__(12);
var imagesUi = __webpack_require__(13);

var deletionID = void 0;

var identifyWebPageToRemove = function identifyWebPageToRemove(event) {
  event.preventDefault();
  deletionID = event.target.dataset.id;
  $('#confirmDeleteWebpageModal').modal('show');
};

var removeWebPage = function removeWebPage(event) {
  webpagesApi.deleteWebpage(deletionID).then(webpagesUI.deleteWebpageSuccess).then(viewMain.goBackToMain).catch(webpagesUI.deleteWebpageFailure);
  // .then(webpagesEvents.onWebpageMaintainedIndex)
  // .catch(webpagesUI.webpageDeleteFailure)
};

var identifyBlogPostToRemove = function identifyBlogPostToRemove(event) {
  event.preventDefault();
  // currentEvent = event
  deletionID = event.target.dataset.id;
...
var removeBlogPost = function removeBlogPost(event) {
  blogPostsApi.blogPostDelete(deletionID).then(viewMain.goBackToMain)
  // .then($('#newcontent').find(`[data-id='${deletionID}']`).hide())
  // .catch(blogPostsUI.blogPostDeleteFailure)
  .then(blogPostsUI.blogPostDeleteSuccess).catch(blogPostsUI.blogPostDeleteFailure);
};

var identifyImageToRemove = function identifyImageToRemove(event) {
  event.preventDefault();
  // currentEvent = event
  deletionID = event.target.dataset.id;
...
var removeImage = function removeImage(event) {
  imagesApi.imageDelete(deletionID).then(viewMain.goBackToMain)
  // .then($('#newcontent').find(`[data-id='${deletionID}']`).hide())
  // .catch(blogPostsUI.blogPostDeleteFailure)
  .then(imagesUi.imageDeleteSuccess).catch(imagesUi.imageDeleteFailure);
};
...
var webpagesApi = __webpack_require__(5);
var webpagesEvents = __webpack_require__(18);
var webpagesUI = __webpack_require__(14);
var blogPostsApi = __webpack_require__(10);
var blogPostsEvents = __webpack_require__(19);
var blogPostsUI = __webpack_require__(9);

var updateWebpageForm = __webpack_require__(54);
var updateBlogPostForm = __webpack_require__(55);

var updateID = void 0;

var identifyWebpageToUpdate = function identifyWebpageToUpdate(event) {
  event.preventDefault();
  $('#update-webpage-modal').modal('show');
  updateID = event.target.dataset.id;
  webpagesApi.getWebpage(updateID).then(populateWebpageUpdateForm).catch(webpagesUI.webpageUpdateFailure);
};

var identifyBlogPostToUpdate = function identifyBlogPostToUpdate(event) {
  event.preventDefault();
  $('#update-blogPost-modal').modal('show');
  updateID = event.target.dataset.id;
  blogPostsApi.blogPostShow(updateID).then(populateBlogPostUpdateForm).catch(blogPostsUI.blogPostUpdateFailure);
};

var populateWebpageUpdateForm = function populateWebpageUpdateForm(response) {
  var updateWebpagesHtml = updateWebpageForm({ webpages: response });
  $('#update-webpage-span').html(updateWebpagesHtml);
  $('#update-webpage').on('submit', webpagesEvents.onUpdateWebpage);
};

var populateBlogPostUpdateForm = function populateBlogPostUpdateForm(response) {
  var updateBlogPostsHtml = updateBlogPostForm({ blogPosts: response });
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <form id=\"update-webpage\" class=\"border\">\n    <fieldset>\n      <form id=\"update-webpage\" class=\"border\">\n        <input type=\"text\" name=\"webpage[title]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\" placeholder=\"title\" required>\n        <input name=\"webpage[id]\" type=\"hidden\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n        <textarea class=\"form-control\" id=\"update-webpage-body\" name=\"webpage[body]\" placeholder=\"Body\" rows=\"3\" required>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
    + "</textarea>\n        <button type=\"submit\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#update-webpage-modal\">Submit</button>\n        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n      </form>\n    </fieldset>\n  </form>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <form id=\"update-blogPost\" class=\"border\">\n    <fieldset>\n      <form id=\"update-blogPost\" class=\"border\">\n        <input type=\"text\" name=\"blogPost[title]\" placeholder=\"blog title\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\" required>\n        <input name=\"blogPost[id]\" type=\"hidden\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n        <textarea class=\"form-control\" id=\"update-blogPost-body\" name=\"blogPost[body]\" placeholder=\"Body\" rows=\"3\" required>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.body : stack1), depth0))
    + "</textarea>\n\n        <button type=\"submit\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#update-blogPost-modal\">Submit</button>\n        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n      </form>\n    </fieldset>\n  </form>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.blogPosts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
...
var onUploadImage = function onUploadImage(event) {
  ...
  $('#content').append(data);
  api.uploadImage(formData).then(ui.imageCreateSuccess).catch(ui.onUploadImageError);
};
